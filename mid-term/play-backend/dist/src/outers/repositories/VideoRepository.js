...
class VideoRepository {
    constructor(datastoreOne) {
        this.readAll = () => __awaiter(this, void 0, void 0, function* () {
            const foundEntities = yield VideoSchema_1.default.find();
        ...
        this.readOneById = (id) => __awaiter(this, void 0, void 0, function* () {
            const foundEntity = yield VideoSchema_1.default.findOne({ _id: id });
            if (foundEntity === null) {
        ...
        this.createOne = (entity) => __awaiter(this, void 0, void 0, function* () {
            return yield VideoSchema_1.default.create(entity);
        });
        this.patchOneById = (id, entity) => __awaiter(this, void 0, void 0, function* () {
            const patchedEntity = yield VideoSchema_1.default.findOneAndUpdate({ _id: id }, { $set: entity }, { new: true });
        ...
        this.deleteOneById = (id) => __awaiter(this, void 0, void 0, function* () {
            const deletedEntity = yield VideoSchema_1.default.findOneAndDelete({ _id: id });
