...
class VideoProductMapManagement {
    constructor(videoProductMapRepository) {
        ...
        this.readAllAggregated = () => __awaiter(this, void 0, void 0, function* () {
            const foundVideoProductMaps = yield this.videoProductMapRepository.readAllAggregated();
            return new Result_1.default(200, 'VideoProductMap read all aggregated succeed.', foundVideoProductMaps);
        });
