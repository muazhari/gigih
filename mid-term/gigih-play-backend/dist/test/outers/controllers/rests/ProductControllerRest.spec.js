...
(0, mocha_1.describe)('ProductControllerRest', () => {
    ...
    (0, mocha_1.describe)('GET /api/v1/products', () => {
        (0, mocha_1.it)('should return 200 OK', () => __awaiter(void 0, void 0, void 0, function* () {
            const response = yield chai_1.default.request(App_1.app).get('/api/v1/products');
    ...
    (0, mocha_1.describe)('GET /api/v1/products/videos/:videoId', () => {
        (0, mocha_1.it)('should return 200 OK', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const response = yield chai_1.default.request(App_1.app).get(`/api/v1/products/videos/${selectedVideoProductMapMock.videoId}`);
            response.should.have.status(200);
            response.body.should.be.a('object');
            response.body.should.have.property('status').eq(200);
            response.body.should.have.property('message');
    ...
    (0, mocha_1.describe)('GET /api/v1/products/:id', () => {
        (0, mocha_1.it)('should return 200 OK', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const response = yield chai_1.default.request(App_1.app).get(`/api/v1/products/${selectedProductMock._id}`);
            response.should.have.status(200);
            response.body.should.be.a('object');
            response.body.should.have.property('status').eq(200);
            response.body.should.have.property('message');
    ...
    (0, mocha_1.describe)('POST /api/v1/products', () => {
        (0, mocha_1.it)('should return 201 CREATED', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const response = yield chai_1.default.request(App_1.app).post('/api/v1/products').send(selectedProductMock);
    ...
    (0, mocha_1.describe)('PATCH /api/v1/products/:id', () => {
        (0, mocha_1.it)('should return 200 OK', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const response = yield chai_1.default.request(App_1.app).patch(`/api/v1/products/${selectedProductMock._id}`).send(selectedProductMock);
            response.should.have.status(200);
            response.body.should.be.a('object');
            response.body.should.have.property('status').eq(200);
            response.body.should.have.property('message');
    ...
    (0, mocha_1.describe)('DELETE /api/v1/products/:id', () => {
        (0, mocha_1.it)('should return 200 OK', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const response = yield chai_1.default.request(App_1.app).delete(`/api/v1/products/${selectedProductMock._id}`);
            response.should.have.status(200);
            response.body.should.be.a('object');
            response.body.should.have.property('status').eq(200);
            response.body.should.have.property('message');
