...
class CommentRepository {
    constructor(datastoreOne) {
        this.readAll = (search) => __awaiter(this, void 0, void 0, function* () {
            if (search !== undefined) {
                ...
                if (search.userId !== undefined) {
                    search.userId = new mongoose_1.Types.ObjectId(search.userId);
                }
            }
            const foundComment = yield CommentSchema_1.default.find(search);
        ...
        this.readAllAggregated = (search) => __awaiter(this, void 0, void 0, function* () {
            ...
            const foundComment = yield CommentSchema_1.default.aggregate(pipeline);
            if (foundComment === null) {
                throw new Error('Found comments is null.');
            }
            return foundComment;
