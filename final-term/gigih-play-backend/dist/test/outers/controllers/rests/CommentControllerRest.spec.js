...
(0, mocha_1.describe)('CommentControllerRest', () => {
    ...
    (0, mocha_1.describe)('GET /api/v1/comments', () => {
        (0, mocha_1.it)('should return 200 OK', () => __awaiter(void 0, void 0, void 0, function* () {
            const response = yield chai_1.default.request(App_1.server).get('/api/v1/comments');
    ...
    (0, mocha_1.describe)('GET /api/v1/comments?is_aggregated=true', () => {
        (0, mocha_1.it)('should return 200 OK', () => __awaiter(void 0, void 0, void 0, function* () {
            const response = yield chai_1.default.request(App_1.server).get('/api/v1/comments?is_aggregated=true');
            response.should.have.status(200);
            response.body.should.be.a('object');
            response.body.should.have.property('status').eq(200);
            response.body.should.have.property('message');
    ...
    (0, mocha_1.describe)('GET /api/v1/comments?search=encoded', () => {
        (0, mocha_1.it)('should return 200 OK', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const response = yield chai_1.default.request(App_1.server).get(`/api/v1/comments?search=${encodedSearch}`);
            response.should.have.status(200);
            response.body.should.be.a('object');
            response.body.should.have.property('status').eq(200);
            response.body.should.have.property('message');
            response.body.should.have.property('data').a('array');
            response.body.data.should.deep.include(humps_1.default.decamelizeKeys(JSON.parse(JSON.stringify(selectedCommentMock))));
        }));
    });
    (0, mocha_1.describe)('GET /api/v1/comments?is_aggregated=true&search=encoded', () => {
        (0, mocha_1.it)('should return 200 OK', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const response = yield chai_1.default.request(App_1.server).get(`/api/v1/comments?is_aggregated=true&search=${encodedSearch}`);
            response.should.have.status(200);
            response.body.should.be.a('object');
            response.body.should.have.property('status').eq(200);
            response.body.should.have.property('message');
            response.body.should.have.property('data').a('array');
            response.body.data.should.deep.include(humps_1.default.decamelizeKeys(JSON.parse(JSON.stringify(selectedCommentMockAggregated))));
        }));
    });
    (0, mocha_1.describe)('GET /api/v1/comments/videos/:videoId', () => {
        (0, mocha_1.it)('should return 200 OK', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const response = yield chai_1.default.request(App_1.server).get(`/api/v1/comments/videos/${selectedVideoCommentMapMock.videoId}`);
            response.should.have.status(200);
            response.body.should.be.a('object');
            response.body.should.have.property('status').eq(200);
            response.body.should.have.property('message');
    ...
    (0, mocha_1.describe)('GET /api/v1/comments/videos/:videoId?is_aggregated=true', () => {
        (0, mocha_1.it)('should return 200 OK', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const response = yield chai_1.default.request(App_1.server).get(`/api/v1/comments/videos/${selectedVideoCommentMapMock.videoId}?is_aggregated=true`);
            response.should.have.status(200);
            response.body.should.be.a('object');
            response.body.should.have.property('status').eq(200);
            response.body.should.have.property('message');
    ...
    (0, mocha_1.describe)('GET /api/v1/comments/:id', () => {
        (0, mocha_1.it)('should return 200 OK', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const response = yield chai_1.default.request(App_1.server).get(`/api/v1/comments/${selectedCommentMock._id}`);
            response.should.have.status(200);
            response.body.should.be.a('object');
            response.body.should.have.property('status').eq(200);
            response.body.should.have.property('message');
    ...
    (0, mocha_1.describe)('GET /api/v1/comments/:id?is_aggregated=true', () => {
        (0, mocha_1.it)('should return 200 OK', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const response = yield chai_1.default.request(App_1.server).get(`/api/v1/comments/${selectedCommentMockAggregated._id}?is_aggregated=true`);
            response.should.have.status(200);
            response.body.should.be.a('object');
            response.body.should.have.property('status').eq(200);
            response.body.should.have.property('message');
    ...
    (0, mocha_1.describe)('POST /api/v1/comments/submissions', () => {
        (0, mocha_1.it)('should return 201 CREATED', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const response = yield chai_1.default.request(App_1.server).post('/api/v1/comments/submissions').send(submitCommentRequest);
    ...
    (0, mocha_1.describe)('POST /api/v1/comments/submissions?is_aggregated=true', () => {
        (0, mocha_1.it)('should return 201 CREATED', () => __awaiter(void 0, void 0, void 0, function* () {
            const selectedVideoMock = videoCommentMapMock.videoMock.data[0];
            const selectedUserMock = videoCommentMapMock.commentMock.userMock.data[0];
            if (selectedVideoMock._id === undefined) {
            ...
            const submitCommentRequest = new SubmitCommentRequest_1.default(selectedVideoMock._id.toString(), selectedUserMock.username, 'content submit');
            const response = yield chai_1.default.request(App_1.server).post('/api/v1/comments/submissions?is_aggregated=true').send(submitCommentRequest);
            response.should.have.status(201);
            response.body.should.be.a('object');
            response.body.should.have.property('status').eq(201);
            response.body.should.have.property('message');
    ...
    (0, mocha_1.describe)('POST /api/v1/comments', () => {
        (0, mocha_1.it)('should return 201 CREATED', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const response = yield chai_1.default.request(App_1.server).post('/api/v1/comments').send(selectedCommentMock);
            response.should.have.status(201);
            response.body.should.be.a('object');
            response.body.should.have.property('status').eq(201);
            response.body.should.have.property('message');
    ...
    (0, mocha_1.describe)('PATCH /api/v1/comments/:id', () => {
        (0, mocha_1.it)('should return 200 OK', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const response = yield chai_1.default.request(App_1.server).patch(`/api/v1/comments/${selectedCommentMock._id}`).send(selectedCommentMock);
            response.should.have.status(200);
            response.body.should.be.a('object');
            response.body.should.have.property('status').eq(200);
            response.body.should.have.property('message');
    ...
    (0, mocha_1.describe)('DELETE /api/v1/comments/:id', () => {
        (0, mocha_1.it)('should return 200 OK', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const response = yield chai_1.default.request(App_1.server).delete(`/api/v1/comments/${selectedCommentMock._id}`);
            response.should.have.status(200);
            response.body.should.be.a('object');
            response.body.should.have.property('status').eq(200);
            response.body.should.have.property('message');
