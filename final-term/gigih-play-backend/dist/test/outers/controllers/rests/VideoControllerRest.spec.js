...
(0, mocha_1.describe)('VideoControllerRest', () => {
    ...
    (0, mocha_1.describe)('GET /api/v1/videos', () => {
        (0, mocha_1.it)('should return 200 OK', () => __awaiter(void 0, void 0, void 0, function* () {
            const response = yield chai_1.default.request(App_1.server).get('/api/v1/videos');
    ...
    (0, mocha_1.describe)('GET /api/v1/videos?search=encoded', () => {
        (0, mocha_1.it)('should return 200 OK', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const response = yield chai_1.default.request(App_1.server).get(`/api/v1/videos?search=${encodedSearch}`);
            response.should.have.status(200);
            response.body.should.be.a('object');
            response.body.should.have.property('status').eq(200);
            response.body.should.have.property('message');
            response.body.should.have.property('data').a('array');
            response.body.data.should.deep.include(humps_1.default.decamelizeKeys(JSON.parse(JSON.stringify(selectedVideoMock))));
        }));
    });
    (0, mocha_1.describe)('GET /api/v1/videos/:id', () => {
        (0, mocha_1.it)('should return 200 OK', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const response = yield chai_1.default.request(App_1.server).get(`/api/v1/videos/${selectedVideoMock._id}`);
            response.should.have.status(200);
            response.body.should.be.a('object');
            response.body.should.have.property('status').eq(200);
            response.body.should.have.property('message');
    ...
    (0, mocha_1.describe)('POST /api/v1/videos', () => {
        (0, mocha_1.it)('should return 201 CREATED', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const response = yield chai_1.default.request(App_1.server).post('/api/v1/videos').send(selectedVideoMock);
    ...
    (0, mocha_1.describe)('PATCH /api/v1/videos/:id', () => {
        (0, mocha_1.it)('should return 200 OK', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const response = yield chai_1.default.request(App_1.server).patch(`/api/v1/videos/${selectedVideoMock._id}`).send(selectedVideoMock);
            response.should.have.status(200);
            response.body.should.be.a('object');
            response.body.should.have.property('status').eq(200);
            response.body.should.have.property('message');
    ...
    (0, mocha_1.describe)('DELETE /api/v1/videos/:id', () => {
        (0, mocha_1.it)('should return 200 OK', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const response = yield chai_1.default.request(App_1.server).delete(`/api/v1/videos/${selectedVideoMock._id}`);
            response.should.have.status(200);
            response.body.should.be.a('object');
            response.body.should.have.property('status').eq(200);
            response.body.should.have.property('message');
