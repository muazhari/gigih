...
(0, mocha_1.describe)('VideoProductMapControllerRest', () => {
    ...
    (0, mocha_1.describe)('GET /api/v1/video-product-maps', () => {
        (0, mocha_1.it)('should return 200 OK', () => __awaiter(void 0, void 0, void 0, function* () {
            const response = yield chai_1.default.request(App_1.server).get('/api/v1/video-product-maps');
    ...
    (0, mocha_1.describe)('GET /api/v1/video-product-maps?is_aggregated=true', () => {
        (0, mocha_1.it)('should return 200 OK', () => __awaiter(void 0, void 0, void 0, function* () {
            const response = yield chai_1.default.request(App_1.server).get('/api/v1/video-product-maps?is_aggregated=true');
            response.should.have.status(200);
            response.body.should.be.a('object');
            response.body.should.have.property('status').eq(200);
            response.body.should.have.property('message');
    ...
    (0, mocha_1.describe)('GET /api/v1/video-product-maps?search=encoded', () => {
        (0, mocha_1.it)('should return 200 OK', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const response = yield chai_1.default.request(App_1.server).get(`/api/v1/video-product-maps?search=${encodedSearch}`);
            response.should.have.status(200);
            response.body.should.be.a('object');
            response.body.should.have.property('status').eq(200);
            response.body.should.have.property('message');
            response.body.should.have.property('data').a('array');
            response.body.data.should.deep.include(humps_1.default.decamelizeKeys(JSON.parse(JSON.stringify(selectedVideoProductMapMock))));
        }));
    });
    (0, mocha_1.describe)('GET /api/v1/video-product-maps?is_aggregated=true&search=encoded', () => {
        (0, mocha_1.it)('should return 200 OK', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const response = yield chai_1.default.request(App_1.server).get(`/api/v1/video-product-maps?is_aggregated=true&search=${encodedSearch}`);
            response.should.have.status(200);
            response.body.should.be.a('object');
            response.body.should.have.property('status').eq(200);
            response.body.should.have.property('message');
            response.body.should.have.property('data').a('array');
            response.body.data.should.deep.include(humps_1.default.decamelizeKeys(JSON.parse(JSON.stringify(selectedVideoProductMapAggregateMock))));
        }));
    });
    (0, mocha_1.describe)('GET /api/v1/video-product-maps/:id', () => {
        (0, mocha_1.it)('should return 200 OK', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const response = yield chai_1.default.request(App_1.server).get(`/api/v1/video-product-maps/${selectedVideoProductMapMock._id}`);
            response.should.have.status(200);
            response.body.should.be.a('object');
            response.body.should.have.property('status').eq(200);
            response.body.should.have.property('message');
    ...
    (0, mocha_1.describe)('GET /api/v1/video-product-maps/:id?is_aggregated=true', () => {
        (0, mocha_1.it)('should return 200 OK', () => __awaiter(void 0, void 0, void 0, function* () {
            const selectedVideoProductMapMock = videoProductMapMock.data[0];
            if (selectedVideoProductMapMock._id === undefined) {
                throw new Error('Selected videoProductMap mock id is undefined.');
            }
            const response = yield chai_1.default.request(App_1.server).get(`/api/v1/video-product-maps/${selectedVideoProductMapMock._id}?is_aggregated=true`);
            response.should.have.status(200);
            response.body.should.be.a('object');
            response.body.should.have.property('status').eq(200);
            response.body.should.have.property('message');
    ...
    (0, mocha_1.describe)('POST /api/v1/video-product-maps', () => {
        (0, mocha_1.it)('should return 201 CREATED', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const response = yield chai_1.default.request(App_1.server).post('/api/v1/video-product-maps').send(selectedVideoProductMapMock);
    ...
    (0, mocha_1.describe)('PATCH /api/v1/video-product-maps/:id', () => {
        (0, mocha_1.it)('should return 200 OK', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const response = yield chai_1.default.request(App_1.server).patch(`/api/v1/video-product-maps/${selectedVideoProductMapMock._id}`).send(selectedVideoProductMapMock);
            response.should.have.status(200);
            response.body.should.be.a('object');
            response.body.should.have.property('status').eq(200);
            response.body.should.have.property('message');
    ...
    (0, mocha_1.describe)('DELETE /api/v1/video-product-maps/:id', () => {
        (0, mocha_1.it)('should return 200 OK', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const response = yield chai_1.default.request(App_1.server).delete(`/api/v1/video-product-maps/${selectedVideoProductMapMock._id}`);
            response.should.have.status(200);
            response.body.should.be.a('object');
            response.body.should.have.property('status').eq(200);
            response.body.should.have.property('message');
