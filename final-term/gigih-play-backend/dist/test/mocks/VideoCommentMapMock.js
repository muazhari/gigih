...
class VideoCommentMapMock {
    constructor() {
        ...
        this.aggregatedData = [
            new VideoCommentMapAggregate_1.default(this.videoMock.data[0], this.commentMock.aggregatedData[0], this.data[0]._id),
            new VideoCommentMapAggregate_1.default(this.videoMock.data[1], this.commentMock.aggregatedData[1], this.data[1]._id)
        ];
    }
}
